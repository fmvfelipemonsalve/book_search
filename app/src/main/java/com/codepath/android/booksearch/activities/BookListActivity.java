...
import com.codepath.android.booksearch.support.ItemClickSupport;
...
public class BookListActivity extends AppCompatActivity {
        ...
        ItemClickSupport.addTo(rvBooks).setOnItemClickListener(
                new ItemClickSupport.OnItemClickListener() {
                    ...
                    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                        //Log.i("BookListActivity",String.format("Success at position %s!",position));
                        switchActivity(abooks.get(position));
                    }
                }
        );
    ...
    private void switchActivity(Book book){
